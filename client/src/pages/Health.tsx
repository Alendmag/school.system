...
import { HeartPulse, Plus, TriangleAlert as AlertTriangle } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <Card className="border-orange-200 bg-orange-50 dark:bg-orange-900/20 dark:border-orange-800">
        <CardContent className="p-6 flex gap-4 items-start">
          ...
          <div>
            <h3 className="font-bold text-orange-800 dark:text-orange-300">تنبيهات الحساسية والأمراض المزمنة</h3>
            <p className="text-orange-700 dark:text-orange-400 text-sm mt-1">يوجد 12 طالباً مسجلاً بحالات ربو، و 4 حالات حساسية طعام. يرجى إبلاغ المشرفين.</p>
          </div>
        </CardContent>
      </Card>
